...
const ProductDetails = ({ logins, postUserOffers, postUserComments, postUserBookmarks, getProductDetails, productDetails, getProductComments, productComments }) => {
    ...
    const modalComment = () => {
        return (<div id="modalComment">
            ...
            <textarea id="comment" placeholder="Type your questions or comments here..."></textarea>
    ...
    if (productDetails.data) {
        return (
            <>
                ...
                <br />
                <span id="backToListing" style={{ fontSize: 15, marginLeft: 30 }} onClick={() => history.push("/")}>Back To Lising Page</span>
                <br />
                <div id="details">
                    <Grid container>
                        <Grid item xs={6}>
